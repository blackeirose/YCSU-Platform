...
Publishing contract/schema: docs/WRITING.md. UI decisions: DESIGN.md. Exact QA, Core revision and deployment evidence: docs/releases/main-writing-v1.md. Release is pending the gates recorded there.
