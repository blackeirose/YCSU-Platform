...
const snapshot=assertPublicRegistry(JSON.parse(await readFile(path.join(root,'data/registry.public.snapshot.json'),'utf8')));
if(snapshot.products.length)throw new Error('Static Registry fallback must be empty: live lifecycle cannot be verified offline');
