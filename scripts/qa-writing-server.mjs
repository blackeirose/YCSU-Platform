...
const db=new PGlite();await db.exec('create role anon;create role authenticated;create role service_role bypassrls;');await db.exec(await readFile(path.join(root,'supabase/migrations/20260918185542_main_writing_presentation.sql'),'utf8'));
